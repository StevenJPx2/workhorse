...
class MemoryService {
  ...
  emitEvent(issueId: string, type: IssueEventType, message: string, metadata?: Record<string, unknown>): Promise<void>
...
```typescript
interface SearchResult { id: string; score: number; content?: string; metadata?: Record<string, unknown> }
...
type MemoryDocumentType = "session_memory" | "issue_context" | "pr_context" | "decision" | "code_context" | (string & {})
