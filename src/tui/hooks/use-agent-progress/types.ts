...
import type { SessionEvent, SessionMemory } from "#core/session/session-types.ts";
...
/**
 * Dependencies for useAgentProgress hook (for testing)
 */
export interface UseAgentProgressDeps {
