...
} from "#core/notifications/types.ts";
...
/**
 * Dependencies for useNotifications hook (for testing)
 */
export interface UseNotificationsDeps {
  getDatabase: () => Database;
  getNotificationsByTicket: (db: Database, ticketId: string) => Notification[];
  createNotification: (db: Database, input: CreateNotificationInput) => Notification | null;
  markNotificationRead: (db: Database, id: string) => void;
  markNotificationAcknowledged: (db: Database, id: string) => void;
  acknowledgeNotifications: (db: Database, ids: string[]) => void;
  deleteNotification: (db: Database, id: string) => void;
}
