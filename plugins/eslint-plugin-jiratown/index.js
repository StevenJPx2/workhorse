...
var rule2 = {
  meta: {
    docs: {
      description:
        "Enforce kebab-case file naming convention. Jiratown convention: all files must use kebab-case (e.g., ticket-sidebar.tsx).",
    },
  },
  create(context) {
  ...
  create(context) {
    ...
    try {
      ...
      const sourceFiles = entries.filter(
        (e) =>
          SOURCE_EXTENSIONS.has(path2.extname(e)) &&
          !e.endsWith(".test.ts") &&
          !e.endsWith(".test.tsx"),
      );
...
export { eslint_plugin_jiratown_default as default };
