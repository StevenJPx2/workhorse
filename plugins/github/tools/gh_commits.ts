...
export default tool({
  ...
  docs: `
gh_commits — recent commits, or one commit's diff summary.
...
NOTES
  Use \`path\` to learn how a file has actually evolved before changing it — recent
  commits often explain WHY the current shape exists.
  Read-only.
`,
