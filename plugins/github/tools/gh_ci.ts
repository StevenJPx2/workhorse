...
THE USUAL LOOP
  1. { branch: "fix/login" }  → find the failing run, note its id
  2. { runId: 1234567 }       → see which steps actually failed

EXAMPLES

  { branch: "main" }
  { runId: 1234567 }
  {}                          // most recent runs, any branch

NOTES
  Read-only. Use this instead of guessing why CI is red.
`,
