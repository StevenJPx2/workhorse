import * as vue from "/Users/stevenjohn/Documents/Projects/workhorse/ui/node_modules/vue/index.mjs";
import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, defineAsyncComponent, computed, provide, Fragment, defineComponent, toRefs, renderSlot, watch, nextTick, toHandlerKey, camelize, watchEffect, h, Comment, mergeProps, cloneVNode, openBlock, createBlock, unref, withCtx, createVNode, createCommentVNode, withKeys, toValue, normalizeStyle, Teleport, markRaw, watchPostEffect, createElementBlock, mergeDefaults, normalizeProps, guardReactiveProps, withModifiers, resolveDynamicComponent, onScopeDispose, createTextVNode, toDisplayString, renderList, toHandlers, onServerPrefetch, useSSRContext, useModel, mergeModels, resolveComponent, useSlots, useTemplateRef, useId as useId$1, Suspense, onErrorCaptured, createApp } from "/Users/stevenjohn/Documents/Projects/workhorse/ui/node_modules/vue/index.mjs";
import { $fetch as $fetch$1 } from "/Users/stevenjohn/Documents/Projects/workhorse/ui/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/stevenjohn/Documents/Projects/workhorse/ui/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/stevenjohn/Documents/Projects/workhorse/ui/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "/Users/stevenjohn/Documents/Projects/workhorse/ui/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, RouterView } from "vue-router";
import defu$1, { defu, defuFn } from "/Users/stevenjohn/Documents/Projects/workhorse/ui/node_modules/defu/dist/defu.mjs";
import { parseURL, encodePath, decodePath, withQuery, hasProtocol, isScriptProtocol, joinURL, parseQuery, withTrailingSlash, withoutTrailingSlash } from "/Users/stevenjohn/Documents/Projects/workhorse/ui/node_modules/ufo/dist/index.mjs";
import { useHead as useHead$1, headSymbol } from "/Users/stevenjohn/Documents/Projects/workhorse/ui/node_modules/@unhead/vue/dist/index.mjs";
import { klona } from "/Users/stevenjohn/Documents/Projects/workhorse/ui/node_modules/klona/dist/index.mjs";
...
import { createSharedComposable, useEventListener, unrefElement, defaultWindow, useVModel, onKeyStroke, createGlobalState, useMounted, computedEager, refAutoReset as refAutoReset$1, useDebounceFn, useResizeObserver, useRafFn, useTimeoutFn as useTimeoutFn$1, reactivePick, reactiveOmit as reactiveOmit$1, createReusableTemplate } from "@vueuse/core";
import { tryOnBeforeUnmount, isClient, isIOS, refAutoReset, tryOnScopeDispose, createEventHook, reactiveOmit, syncRef, useTimeout, useTimeoutFn } from "@vueuse/shared";
import { createTV, cnMerge } from "tailwind-variants";
import { getIconCSS } from "@iconify/utils/lib/css/icon";
import { isEqual, hash } from "/Users/stevenjohn/Documents/Projects/workhorse/ui/node_modules/ohash/dist/index.mjs";
import { debounce } from "/Users/stevenjohn/Documents/Projects/workhorse/ui/node_modules/perfect-debounce/dist/index.mjs";
...
const _routes = [
  {
    name: "tickets-id",
    path: "/tickets/:id()",
    component: () => import("./_nuxt/_id_-Hq_C0YFS.js")
  },
  {
    name: "chat",
    path: "/chat",
    component: () => import("./_nuxt/chat-BX6GhODc.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-nyPSRBJl.js")
  }
];
...
const useBodyLockStackCount = createSharedComposable(() => {
  ...
  watch(locked, (val, oldVal) => {
    ...
    if (verticalScrollbarWidth > 0) {
      (void 0).body.style.paddingRight = typeof config2.padding === "number" ? `${config2.padding}px` : String(config2.padding);
      (void 0).body.style.marginRight = typeof config2.margin === "number" ? `${config2.margin}px` : String(config2.margin);
...
var NavigationMenuRoot_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const isDelaySkipped = refAutoReset$1(false, skipDelayDuration);
...
var NavigationMenuTrigger_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const triggerId = ref("");
    const contentId = ref("");
    const hasPointerMoveOpenedRef = refAutoReset$1(false, 300);
      ...
      if (hasToasts.value && viewport) {
        ...
        const handleKeyDown = (event) => {
          ...
          if (isTabKey) {
            ...
            if (focusFirst$1(sortedCandidates.slice(index2 + 1))) event.preventDefault();
...
const _sfc_main$h = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const { size: size2 } = useAvatarGroup(_props);
    const appConfig2 = useAppConfig();
...
const _sfc_main$g = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(unref(props).chip ? _sfc_main$h : unref(Primitive)), mergeProps({
        as: as.value.root
              ...
              _push2(ssrRenderComponent(unref(Slot), _ctx.$attrs, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    return [
                      renderSlot(_ctx.$slots, "default", {}, () => [
                        unref(props).icon ? (openBlock(), createBlock(_sfc_main$i, {
                          key: 0,
                          name: unref(props).icon,
                          "data-slot": "icon",
                          class: ui.value.icon({ class: unref(props).ui?.icon })
...
const _sfc_main$e = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const appConfig2 = useAppConfig();
    const nuxtApp = useNuxtApp();
    const nuxtLinkProps = useForwardProps$1(reactiveOmit$1(props, "as", "type", "disabled", "active", "exact", "exactQuery", "exactHash", "activeClass", "inactiveClass", "to", "href", "raw", "custom", "locale", "class"));
            ...
            if (_push2) {
              ...
              return [
                __props.custom ? (openBlock(), createBlock(unref(Slot), { key: 0 }, {
                  ...
                  _: 2
                }, 1024)) : (openBlock(), createBlock(_sfc_main$f, mergeProps({ key: 1 }, {
                  ..._ctx.$attrs,
                  ...__props.exact && isExactActive ? { "aria-current": props.ariaCurrentValue } : {},
                  as: __props.as,
                  type: __props.type,
                  ...
                  return [
                    renderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => [
                      unref(isLeading) && unref(leadingIconName) ? (openBlock(), createBlock(_sfc_main$i, {
                        ...
                        "data-slot": "leadingIcon",
                        class: ui.value.leadingIcon({ class: unref(props).ui?.leadingIcon, active })
                      }, null, 8, ["name", "class"])) : !!unref(props).avatar ? (openBlock(), createBlock(_sfc_main$g, mergeProps({
                        key: 1,
                        size: unref(props).ui?.leadingAvatarSize || ui.value.leadingAvatarSize()
                      }, unref(props).avatar, {
                        "data-slot": "leadingAvatar",
      ...
      _push(ssrRenderComponent(unref(ToastRoot_default), mergeProps({
        ...
        default: withCtx(({ remaining, duration: totalDuration, open }, _push2, _parent2, _scopeId) => {
          if (_push2) {
                    ...
                    if (_push3) {
                      ...
                      return [
                        renderSlot(_ctx.$slots, "close", { ui: ui.value }, () => [
                          unref(props).close ? (openBlock(), createBlock(_sfc_main$d, mergeProps({
                            key: 0,
                            icon: unref(props).closeIcon || unref(appConfig2).ui.icons.close,
                            color: "neutral",
                            variant: "link",
            ...
            return [
              renderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => [
                unref(props).avatar ? (openBlock(), createBlock(_sfc_main$g, mergeProps({
                  key: 0,
                  size: unref(props).ui?.avatarSize || ui.value.avatarSize()
                }, unref(props).avatar, {
                  "data-slot": "avatar",
                  class: ui.value.avatar({ class: unref(props).ui?.avatar })
                }), null, 16, ["size", "class"])) : unref(props).icon ? (openBlock(), createBlock(_sfc_main$i, {
                  key: 1,
                  name: unref(props).icon,
                  "data-slot": "icon",
                  class: ui.value.icon({ class: unref(props).ui?.icon })
              ...
              unref(props).progress && open && remaining > 0 && totalDuration ? (openBlock(), createBlock(_sfc_main$c, mergeProps({
                key: 1,
                "model-value": remaining / totalDuration * 100,
                color: unref(props).color
              }, typeof unref(props).progress === "object" ? unref(props).progress : {}, {
...
const UToaster = Object.assign(_sfc_main$a, { __name: "UToaster" });
...
const __nuxt_component_0 = Object.assign(_sfc_main$8, { __name: "UApp" });
const theme$4 = {
  "slots": {
...
const _sfc_main$7 = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$4), ...appConfig2.ui?.badge || {} })({
      color: props.color,
      variant: props.variant,
...
const _sfc_main$6 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const rootProps = useForwardProps(pick2, emits);
    const portalProps = usePortal(toRef(() => props.portal));
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    const appConfig2 = useAppConfig();
    const ui = computed(() => tv({ extend: tv(theme$2), ...appConfig2.ui?.kbd || {} }));
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        as: unref(props).as,
...
const _sfc_main$4 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const arrowProps = toRef(() => defu(props.arrow, { rounded: true }));
    const ui = computed(() => tv({ extend: tv(theme$1), ...appConfig2.ui?.tooltip || {} })({
      side: contentProps.value.side
    }));
    return (_ctx, _push, _parent, _attrs) => {
...
const _sfc_main$3 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme), ...appConfig2.ui?.navigationMenu || {} })({
      orientation: props.orientation,
    ...
    function getItemValue(item, index2, level, listIndex) {
      const prefix = lists.value.length > 1 ? `group-${listIndex}-` : "";
      return get(item, props.valueKey) ?? (level > 0 ? `${prefix}item-${level}-${index2}` : `${prefix}item-${index2}`);
    }
    function getAccordionDefaultValue(list, level = 0, listIndex = 0) {
      const indexes = list.reduce((acc, item, index2) => {
        if (item.defaultOpen || item.open) {
          acc.push(getItemValue(item, index2, level, listIndex));
        }
        return acc;
      }, []);
    ...
    return (_ctx, _push, _parent, _attrs) => {
            ...
            ssrRenderSlot(_ctx.$slots, item.slot || "item", {
              ...
              if (unref(get)(item, unref(props).labelKey) || !!slots[item.slot ? `${item.slot}-label` : "item-label"]) {
                ...
                if (item.target === "_blank" && unref(props).externalIcon !== false) {
                  _push2(ssrRenderComponent(_sfc_main$i, {
                    name: typeof unref(props).externalIcon === "string" ? unref(props).externalIcon : unref(appConfig2).ui.icons.external,
                    ...
                    if (_push3) {
                      ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : "item-trailing", {
                        ...
                        if (unref(props).orientation === "horizontal" && (item.children?.length || !!slots[item.slot ? `${item.slot}-content` : "item-content"]) || unref(props).orientation === "vertical" && item.children?.length) {
                          _push3(ssrRenderComponent(_sfc_main$i, {
                            name: item.trailingIcon || unref(props).trailingIcon || unref(appConfig2).ui.icons.chevronDown,
                      ...
                      return [
                        renderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : "item-trailing", {
                          ...
                          item.badge || item.badge === 0 ? (openBlock(), createBlock(_sfc_main$7, mergeProps({
                            key: 0,
                            color: "neutral",
                            variant: "outline",
                            size: item.ui?.linkTrailingBadgeSize || unref(props).ui?.linkTrailingBadgeSize || ui.value.linkTrailingBadgeSize()
                          ...
                          unref(props).orientation === "horizontal" && (item.children?.length || !!slots[item.slot ? `${item.slot}-content` : "item-content"]) || unref(props).orientation === "vertical" && item.children?.length ? (openBlock(), createBlock(_sfc_main$i, {
                            key: 1,
                            name: item.trailingIcon || unref(props).trailingIcon || unref(appConfig2).ui.icons.chevronDown,
                            "data-slot": "linkTrailingIcon",
                            class: ui.value.linkTrailingIcon({ class: [unref(props).ui?.linkTrailingIcon, item.ui?.linkTrailingIcon], active })
                          }, null, 8, ["name", "class"])) : item.trailingIcon ? (openBlock(), createBlock(_sfc_main$i, {
                            key: 2,
                            name: item.trailingIcon,
                            "data-slot": "linkTrailingIcon",
                            class: ui.value.linkTrailingIcon({ class: [unref(props).ui?.linkTrailingIcon, item.ui?.linkTrailingIcon], active })
            ...
            return [
              renderSlot(_ctx.$slots, item.slot || "item", {
                ...
                renderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : "item-leading", {
                  ...
                  item.avatar ? (openBlock(), createBlock(_sfc_main$g, mergeProps({
                    key: 0,
                    size: item.ui?.linkLeadingAvatarSize || unref(props).ui?.linkLeadingAvatarSize || ui.value.linkLeadingAvatarSize()
                  }, item.avatar, {
                    "data-slot": "linkLeadingAvatar",
                    class: ui.value.linkLeadingAvatar({ class: [unref(props).ui?.linkLeadingAvatar, item.ui?.linkLeadingAvatar], active, disabled: !!item.disabled })
                  }), null, 16, ["size", "class"])) : item.icon && item.chip ? (openBlock(), createBlock(_sfc_main$h, mergeProps({
                    key: 1,
                    size: item.ui?.linkLeadingChipSize || unref(props).ui?.linkLeadingChipSize || ui.value.linkLeadingChipSize(),
                    inset: ""
                  }, typeof item.chip === "object" ? item.chip : {}, { "data-slot": "linkLeadingChip" }), {
                    ...
                    _: 2
                  }, 1040, ["size"])) : item.icon ? (openBlock(), createBlock(_sfc_main$i, {
                    key: 2,
                    name: item.icon,
                    "data-slot": "linkLeadingIcon",
                    class: ui.value.linkLeadingIcon({ class: [unref(props).ui?.linkLeadingIcon, item.ui?.linkLeadingIcon], active, disabled: !!item.disabled })
                ...
                unref(get)(item, unref(props).labelKey) || !!slots[item.slot ? `${item.slot}-label` : "item-label"] ? (openBlock(), createBlock("span", {
                  ...
                  item.target === "_blank" && unref(props).externalIcon !== false ? (openBlock(), createBlock(_sfc_main$i, {
                    key: 0,
                    name: typeof unref(props).externalIcon === "string" ? unref(props).externalIcon : unref(appConfig2).ui.icons.external,
                    "data-slot": "linkLabelExternalIcon",
                    class: ui.value.linkLabelExternalIcon({ class: [unref(props).ui?.linkLabelExternalIcon, item.ui?.linkLabelExternalIcon], active })
      ...
      _push(ssrRenderComponent(unref(DefineItemTemplate), null, {
        default: withCtx(({ item, index: index2, level = 0, listIndex = 0 }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(unref(props).orientation === "vertical" && !unref(props).collapsed ? unref(AccordionItem_default) : unref(NavigationMenuItem_default)), mergeProps({ as: "li" }, unref(props).orientation === "vertical" && !unref(props).collapsed ? { disabled: !!item.disabled } : {}, {
              value: getItemValue(item, index2, level, listIndex)
            }), {
              default: withCtx((_, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (unref(props).orientation === "vertical" && item.type === "label" && !unref(props).collapsed) {
                    ...
                    _push3(ssrRenderComponent(_sfc_main$e, mergeProps(unref(props).orientation === "vertical" && item.children?.length && !unref(props).collapsed && item.type === "trigger" ? {} : unref(pickLinkProps)(item), { custom: "" }), {
                          ...
                          ssrRenderVNode(_push4, createVNode(resolveDynamicComponent(unref(props).orientation === "horizontal" && (item.children?.length || !!slots[item.slot ? `${item.slot}-content` : "item-content"]) ? unref(NavigationMenuTrigger_default) : unref(props).orientation === "vertical" && item.children?.length && !unref(props).collapsed && !slotProps.href ? unref(AccordionTrigger_default) : unref(NavigationMenuLink_default)), {
                            ...
                            default: withCtx((_2, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                if (unref(props).orientation === "vertical" && unref(props).collapsed && item.children?.length && (!!unref(props).popover || !!item.popover)) {
                                  _push5(ssrRenderComponent(_sfc_main$6, mergeProps({ ...popoverProps.value, ...typeof item.popover === "boolean" ? {} : item.popover || {} }, {
                                      ...
                                      if (_push6) {
                                        ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-content` : "item-content", {
                                          ...
                                          ssrRenderList(item.children, (childItem, childIndex) => {
                                            ...
                                            _push6(ssrRenderComponent(_sfc_main$e, mergeProps({ ref_for: true }, unref(pickLinkProps)(childItem), { custom: "" }), {
                                                ...
                                                if (_push7) {
                                                  _push7(ssrRenderComponent(unref(NavigationMenuLink_default), {
                                                    ...
                                                    default: withCtx((_3, _push8, _parent8, _scopeId7) => {
                                                      if (_push8) {
                                                        _push8(ssrRenderComponent(_sfc_main$f, mergeProps({ ref_for: true }, childSlotProps, {
                                                          "data-slot": "childLink",
                                                          ...
                                                          default: withCtx((_4, _push9, _parent9, _scopeId8) => {
                                                            if (_push9) {
                                                              if (childItem.icon) {
                                                                _push9(ssrRenderComponent(_sfc_main$i, {
                                                                  name: childItem.icon,
                                                              ...
                                                              return [
                                                                childItem.icon ? (openBlock(), createBlock(_sfc_main$i, {
                                                                  key: 0,
                                                                  name: childItem.icon,
                                                                  "data-slot": "childLinkIcon",
                                                                  class: ui.value.childLinkIcon({ class: [unref(props).ui?.childLinkIcon, item.ui?.childLinkIcon], active: childActive })
                                                                ...
                                                                createVNode("span", {
                                                                  ...
                                                                  childItem.target === "_blank" && unref(props).externalIcon !== false ? (openBlock(), createBlock(_sfc_main$i, {
                                                                    key: 0,
                                                                    name: typeof unref(props).externalIcon === "string" ? unref(props).externalIcon : unref(appConfig2).ui.icons.external,
                                                                    "data-slot": "childLinkLabelExternalIcon",
                                                                    class: ui.value.childLinkLabelExternalIcon({ class: [unref(props).ui?.childLinkLabelExternalIcon, item.ui?.childLinkLabelExternalIcon], active: childActive })
                                                        ...
                                                        return [
                                                          createVNode(_sfc_main$f, mergeProps({ ref_for: true }, childSlotProps, {
                                                            "data-slot": "childLink",
                                                            class: ui.value.childLink({ class: [unref(props).ui?.childLink, item.ui?.childLink, childItem.class], active: childActive })
                                                          }), {
                                                            default: withCtx(() => [
                                            ...
                                            createVNode("ul", {
                                              ...
                                              (openBlock(true), createBlock(Fragment, null, renderList(item.children, (childItem, childIndex) => {
                                                return openBlock(), createBlock("li", {
                                                  ...
                                                  createVNode(_sfc_main$e, mergeProps({ ref_for: true }, unref(pickLinkProps)(childItem), { custom: "" }), {
                                    ...
                                    default: withCtx((_3, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(ssrRenderComponent(_sfc_main$f, mergeProps(slotProps, {
                                          "data-slot": "link",
                                  ...
                                  _push5(ssrRenderComponent(_sfc_main$f, mergeProps(slotProps, {
                                    "data-slot": "link",
                                ...
                                return [
                                  unref(props).orientation === "vertical" && unref(props).collapsed && item.children?.length && (!!unref(props).popover || !!item.popover) ? (openBlock(), createBlock(_sfc_main$6, mergeProps({ key: 0 }, { ...popoverProps.value, ...typeof item.popover === "boolean" ? {} : item.popover || {} }, {
                                    ui: { content: ui.value.content({ class: [unref(props).ui?.content, item.ui?.content] }) }
                                  }), {
                                    ...
                                    _: 2
                                  }, 1040, ["ui"])) : unref(props).orientation === "vertical" && unref(props).collapsed && (!!unref(props).tooltip || !!item.tooltip) || unref(props).orientation === "horizontal" && !!item.tooltip ? (openBlock(), createBlock(_sfc_main$4, mergeProps({
                                    key: 1,
                                    text: unref(get)(item, unref(props).labelKey)
                                  }, { ...tooltipProps.value, ...typeof item.tooltip === "boolean" ? {} : item.tooltip || {} }), {
                                    default: withCtx(() => [
                                    ...
                                    _: 2
                                  }, 1040, ["text"])) : (openBlock(), createBlock(_sfc_main$f, mergeProps({ key: 2 }, slotProps, {
                                    "data-slot": "link",
                                    class: ui.value.link({ class: [unref(props).ui?.link, item.ui?.link, item.class], active: active || item.active, disabled: !!item.disabled, level: unref(props).orientation === "horizontal" || level > 0 })
                                  }), {
                                    default: withCtx(() => [
                                ...
                                if (_push5) {
                                  ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-content` : "item-content", {
                                    ...
                                    ssrRenderList(item.children, (childItem, childIndex) => {
                                      ...
                                      _push5(ssrRenderComponent(_sfc_main$e, mergeProps({ ref_for: true }, unref(pickLinkProps)(childItem), { custom: "" }), {
                                          ...
                                          if (_push6) {
                                            _push6(ssrRenderComponent(unref(NavigationMenuLink_default), {
                                              ...
                                              default: withCtx((_3, _push7, _parent7, _scopeId6) => {
                                                if (_push7) {
                                                  _push7(ssrRenderComponent(_sfc_main$f, mergeProps({ ref_for: true }, childSlotProps, {
                                                    "data-slot": "childLink",
                                                    class: ui.value.childLink({ class: [unref(props).ui?.childLink, item.ui?.childLink, childItem.class], active: childActive })
                                                  }), {
                                                    default: withCtx((_4, _push8, _parent8, _scopeId7) => {
                                                      if (_push8) {
                                                        if (childItem.icon) {
                                                          _push8(ssrRenderComponent(_sfc_main$i, {
                                                            name: childItem.icon,
                                                            "data-slot": "childLinkIcon",
                                                            class: ui.value.childLinkIcon({ class: [unref(props).ui?.childLinkIcon, item.ui?.childLinkIcon], active: childActive })
                  ...
                  return [
                    ...
                    ], 2)) : item.type !== "label" ? (openBlock(), createBlock(_sfc_main$e, mergeProps({ key: 1 }, unref(props).orientation === "vertical" && item.children?.length && !unref(props).collapsed && item.type === "trigger" ? {} : unref(pickLinkProps)(item), { custom: "" }), {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UApp, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="min-h-screen"${_scopeId}><header class="border-b border-default px-4 py-3 flex items-center gap-6"${_scopeId}>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  return [
                    ...
                    createTextVNode(" Workhorse ")
                  ];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_UNavigationMenu, { items: links }, null, _parent2, _scopeId));
            _push2(`</header><main class="p-4 max-w-5xl mx-auto"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_NuxtPage, null, null, _parent2, _scopeId));
            _push2(`</main></div>`);
          } else {
            return [
              createVNode("div", { class: "min-h-screen" }, [
                createVNode("header", { class: "border-b border-default px-4 py-3 flex items-center gap-6" }, [
                  ...
                  createVNode(_component_UNavigationMenu, { items: links })
                ]),
                createVNode("main", { class: "p-4 max-w-5xl mx-auto" }, [
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-lGrV4MmY.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CpWGFbtT.js"));
...
export {
  ...
  useComponentProps as e,
  useAppConfig as f,
  useFormField as g,
  useComponentIcons as h,
  _sfc_main$i as i,
  _sfc_main$g as j,
  useNuxtApp as k,
  looseToNumber as l,
  defineKeyedFunctionFactory as m,
  fetchDefaults as n,
  useAsyncData as o,
  useFieldGroup as p,
  tv as t,
