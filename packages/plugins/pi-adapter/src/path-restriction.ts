 ...
 *
 * Wraps Pi SDK tool operations with path validation from @jiratown/core
 ...
 *
 * @module @jiratown/plugin-pi-adapter/path-restriction
 */
...
import { assertPathAllowed, type PathValidationOptions } from "@jiratown/core";
import type {
  WriteOperations,
  ReadOperations,
  EditOperations,
