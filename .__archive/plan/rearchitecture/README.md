...
4. Update the **Status** section above (test count, what's next).
5. Append an entry to `SESSION-LOG.md`: date, what landed, test count, the next concrete action, and
   any new gotcha worth pinning here.
6. Keep design docs clean — record history in `SESSION-LOG.md`, never as changelog prose inside
